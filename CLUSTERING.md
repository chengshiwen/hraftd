...
```
./bin/hraftd -id node1 -haddr 192.168.0.1:11000 -raddr 192.168.0.1:12000 ~/node
```
...
```
./bin/hraftd -id node2 -haddr 192.168.0.2:11000 -raddr 192.168.0.2:12000 -join 192.168.0.1:11000 ~/node
```

Finally, start the third node as follows:
```
./bin/hraftd -id node3 -haddr 192.168.0.3:11000 -raddr 192.168.0.3:12000 -join 192.168.0.2:11000 ~/node
```
